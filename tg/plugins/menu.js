...
const CATEGORIES = {
    games: ['brainout', 'caklontong', 'heroff', 'heroml', 'jkt48', 'drakor', 'riddle', 'whatanimal', 'whatchemistry', 'whatcountry', 'whatfilm', 'whatflag', 'whatfood', 'whatlyric', 'whatpicture', 'whatprofession', 'whatword', 'whoami'],
    tools: ['ping'],
    misc: ['menu']
};
...
export default (bot) => {
        ...
        try {
            ...
            await ctx.reply(message, {
                ...
                ...Markup.inlineKeyboard([
                    ...
                    [Markup.button.url('💰 Donate', 'https://github.com/itsliaaa/starseed')]
                ])
            });

        } catch (error) {
            global.consolefy?.error(error) || console.error("Error in menu command:", error);
    ...
    bot.action('menu_statistic', async (ctx) => {
        try {
            ...
            await ctx.reply('Statistics feature is not yet fully implemented for Telegram.');
        } catch (e) {
