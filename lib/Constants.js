...
export const AVAILABLE_MODELS = Object.freeze({
  "gemini-flash-latest": {
    description:
      "An alias to Gemini latest Flash model which changes over time.",
    subscriptionOnly: false,
  },
  "gemini-flash-lite-latest": {
    description:
      "An alias to Gemini latest Flash-Lite model which changes over time.",
    subscriptionOnly: false,
  },
  "gemini-3.1-pro-preview": {
    description:
      "Gemini latest SOTA reasoning model with unprecedented depth and nuance, and powerful multimodal understanding and coding capabilities.",
    subscriptionOnly: true,
  },
  "gemini-3-flash-preview": {
    description:
      "Gemini most intelligent model built for speed, combining frontier intelligence with superior search and grounding.",
    subscriptionOnly: true,
  },
  "gemini-2.5-pro": {
    description:
      "Gemini previous generation advanced reasoning model, which excels at coding and complex reasoning tasks.",
    subscriptionOnly: true,
  },
  "gemini-2.5-flash": {
    description:
      "Gemini hybrid reasoning model, with a 1M token context window and thinking budgets.",
    subscriptionOnly: false,
  },
  "gemini-2.0-flash": {
    description:
      "Gemini second generation multimodal model with great performance across all tasks.",
    subscriptionOnly: false,
  },
  "gemini-3.1-flash-lite-preview": {
    description:
      "Gemini most cost-efficient model, optimized for high-volume agentic tasks, translation, and simple data processing.",
    subscriptionOnly: true,
  },
  "gemini-2.5-flash-lite": {
    description:
      "Gemini smallest and most cost effective model, built for at scale usage.",
    subscriptionOnly: false,
  },
  "gemini-2.0-flash-lite": {
    description:
      "Gemini second generation small and cost effective model, built for at scale usage.",
    subscriptionOnly: false,
  },
...
export const CATEGORY_DESCRIPTIONS = Object.freeze({
  "admin tools":
    "Commands for managing group members, permissions, and moderation settings.",
  ...
  explore:
    "Discover and search for various content like apps, music, comics, and more.",
  group: "Commands designed to enhance group interaction and engagement.",
  maker:
    "Commands for generating images, stickers, and other creative content.",
  owner:
    "Restricted commands for the bot owner manage and configure the main system.",
  ...
  tools:
    "Utility commands for conversion, formatting, and other practical tasks.",
  "user info":
    "Commands for viewing user profiles, status, statistics, and related information.",
...
export const DE_MORSE = Object.fromEntries(
...
export const FONT_MAPS = Object.fromEntries(
  Object.entries(FONT_VARIANTS).map(([name, variant]) => {
    ...
    return [
      name,
      Object.fromEntries(sourceChars.map((c, i) => [c, variantChars[i]])),
    ];
  }),
);
...
export const IMAGE_TO_WEBP = [
  ...
  "-sn",
  "-vf",
  "scale=512:512:force_original_aspect_ratio=decrease:flags=neighbor,pad=512:512:-1:-1:color=0x00000000,format=rgba",
  "-c:v",
  "libwebp",
  "-q:v",
  "50",
...
export const VIDEO_TO_WEBP = [
  ...
  "-sn",
  "-vf",
  "fps=15,scale=320:320:force_original_aspect_ratio=decrease:flags=neighbor,pad=320:320:-1:-1:color=0x00000000,format=rgba",
  "-c:v",
  "libwebp",
  "-q:v",
  "60",
...
export const BRAT_GIF_ARGS = [
  ...
  "-sn",
  "-vf",
  "fps=5,scale=320:320:force_original_aspect_ratio=decrease:flags=neighbor,pad=320:320:-1:-1:color=0x00000000,split[s0][s1];[s0]palettegen=max_colors=64:stats_mode=full[p];[s1][p]paletteuse=dither=none",
  "-f",
  "gif",
];

export const FFMPEG_CONCAT_ARGS = ["-f", "concat", "-safe", "0"];
